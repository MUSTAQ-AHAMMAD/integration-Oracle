...
public class FetchSingleVendHQ {
    ...
    public FetchSingleVendHQ(String domain, Credential credential) {
        this.domain = domain;
    ...
    public <T> T execute(Class<T> klass, Integer apiVersion, String api, 
                               HashMap<String,String> queryParameters, String itemId) throws IOException {
        ...
        urlBuilder.append(api).append("/").append(String.valueOf(itemId));
        ...
        VendHQObjectSingle<T> objectSingleItem = gson.fromJson(response.body().string(), new VendHQObjectSingleType<T>(klass));
        return objectSingleItem.getData();
    }
