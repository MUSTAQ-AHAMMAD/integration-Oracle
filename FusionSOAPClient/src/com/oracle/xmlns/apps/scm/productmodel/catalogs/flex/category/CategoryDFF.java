...
/**
 * <p>Java class for CategoryDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CategoryDFF">
 *   &lt;complexContent>
...
@XmlType(name = "CategoryDFF", propOrder = {
    "categoryId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class CategoryDFF {

    @XmlElement(name = "CategoryId")
    protected Long categoryId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/scm/productModel/catalogs/flex/category/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/scm/productModel/catalogs/flex/category/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/scm/productModel/catalogs/flex/category/", type = JAXBElement.class, required = false)
