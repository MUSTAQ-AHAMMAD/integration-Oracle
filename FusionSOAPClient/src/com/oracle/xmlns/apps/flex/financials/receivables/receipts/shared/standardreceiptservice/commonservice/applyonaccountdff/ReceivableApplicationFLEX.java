...
/**
 * <p>Java class for ReceivableApplicationFLEX complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReceivableApplicationFLEX">
 *   &lt;complexContent>
...
@XmlType(name = "ReceivableApplicationFLEX", propOrder = {
    "receivableApplicationId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class ReceivableApplicationFLEX {

    @XmlElement(name = "ReceivableApplicationId")
    protected Long receivableApplicationId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountDff/", type = JAXBElement.class, required = false)
