    ...
    extends InterfaceLineReferenceFLEX
{
    ...
    @XmlElementRef(name = "contractNumber", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/transactions/autoInvoices/TransactionInterfaceReferenceDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> contractNumber;
    @XmlElementRef(name = "lineNumber", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/transactions/autoInvoices/TransactionInterfaceReferenceDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lineNumber;
    @XmlElementRef(name = "billingScheduleNumber", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/transactions/autoInvoices/TransactionInterfaceReferenceDff/", type = JAXBElement.class, required = false)
