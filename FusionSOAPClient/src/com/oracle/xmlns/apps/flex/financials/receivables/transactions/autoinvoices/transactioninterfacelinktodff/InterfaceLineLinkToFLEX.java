...
/**
 * <p>Java class for InterfaceLineLinkToFLEX complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InterfaceLineLinkToFLEX">
 *   &lt;complexContent>
...
@XmlType(name = "InterfaceLineLinkToFLEX", propOrder = {
    "interfaceLineGuid",
    "flexContext",
...
@XmlSeeAlso({
    InterfaceLineLinkToFLEXDOO.class
})
public class InterfaceLineLinkToFLEX {

    @XmlElementRef(name = "InterfaceLineGuid", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/transactions/autoInvoices/TransactionInterfaceLinkToDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> interfaceLineGuid;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/transactions/autoInvoices/TransactionInterfaceLinkToDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/transactions/autoInvoices/TransactionInterfaceLinkToDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/transactions/autoInvoices/TransactionInterfaceLinkToDff/", type = JAXBElement.class, required = false)
