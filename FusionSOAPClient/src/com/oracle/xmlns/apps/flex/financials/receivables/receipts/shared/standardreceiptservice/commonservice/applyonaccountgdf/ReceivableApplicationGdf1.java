 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/}ReceivableApplicationGdf">
 *       &lt;sequence>
...
public class ReceivableApplicationGdf1
    extends ReceivableApplicationGdf
{

    @XmlElementRef(name = "_Main__Amount__Received", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> mainAmountReceived;
    @XmlElementRef(name = "_Base__Interest__Calculation", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> baseInterestCalculation;
    @XmlElementRef(name = "_Base__Interest__Calculation_Display", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> baseInterestCalculationDisplay;
    @XmlElementRef(name = "_Calculated__Interest", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> calculatedInterest;
    @XmlElementRef(name = "_Received__Interest", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> receivedInterest;
    @XmlElementRef(name = "_Interest__Difference__Action", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> interestDifferenceAction;
    @XmlElementRef(name = "_Interest__Difference__Action_Display", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> interestDifferenceActionDisplay;
    @XmlElementRef(name = "_Write__Off__Reason", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> writeOffReason;
    @XmlElementRef(name = "_Interest__Payment__Date", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> interestPaymentDate;
    @XmlElementRef(name = "_Write_2DOff__Date", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> write2DOffDate;
    @XmlElementRef(name = "_Calculated__Interest__Tmp", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> calculatedInterestTmp;
    @XmlElementRef(name = "_Received__Interest__Tmp", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> receivedInterestTmp;
    @XmlElementRef(name = "_Interest__Payment__Date__Tmp", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> interestPaymentDateTmp;
    @XmlElementRef(name = "debitMemoNumber", namespace = "http://xmlns.oracle.com/apps/flex/financials/receivables/receipts/shared/standardReceiptService/commonService/ApplyOnAccountGdf/", type = JAXBElement.class, required = false)
