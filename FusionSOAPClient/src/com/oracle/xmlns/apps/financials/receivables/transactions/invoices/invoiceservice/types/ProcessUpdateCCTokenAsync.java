 ...
 *         &lt;element name="updateCCToken" type="{http://xmlns.oracle.com/apps/financials/receivables/transactions/invoices/invoiceService/}UpdateCCToken" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "processUpdateCCTokenAsync")
public class ProcessUpdateCCTokenAsync {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<UpdateCCToken> updateCCToken;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the updateCCToken property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUpdateCCToken().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<UpdateCCToken> getUpdateCCToken() {
        if (updateCCToken == null) {
            updateCCToken = new ArrayList<UpdateCCToken>();
        }
        return this.updateCCToken;
    }
