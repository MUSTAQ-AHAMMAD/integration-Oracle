...
/**
 * <p>Java class for TransactionInterfaceGdfJL_5FBR_5FARXTWMAI_5FAdditional complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TransactionInterfaceGdfJL_5FBR_5FARXTWMAI_5FAdditional">
 *   &lt;complexContent>
...
@XmlType(name = "TransactionInterfaceGdfJL_5FBR_5FARXTWMAI_5FAdditional", propOrder = {
    "interestType",
...
public class TransactionInterfaceGdf10
    extends TransactionInterfaceGdf
{

    @XmlElementRef(name = "_Interest__Type", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> interestType;
    @XmlElementRef(name = "_Interest__Rate___2F__Amount", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> interestRate2FAmount;
    @XmlElementRef(name = "_Interest__Period", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> interestPeriod;
    @XmlElementRef(name = "_Interest__Formula", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> interestFormula;
    @XmlElementRef(name = "_Interest__Grace__Days", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> interestGraceDays;
    @XmlElementRef(name = "_Interest__Penalty__Type", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> interestPenaltyType;
    @XmlElementRef(name = "_Interest__Penalty__Rate___2F__Amount", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
