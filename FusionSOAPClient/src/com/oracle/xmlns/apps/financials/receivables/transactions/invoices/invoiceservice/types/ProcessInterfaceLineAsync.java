 ...
 *         &lt;element name="interfaceLine" type="{http://xmlns.oracle.com/apps/financials/receivables/transactions/invoices/invoiceService/}InterfaceLine" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "processInterfaceLineAsync")
public class ProcessInterfaceLineAsync {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<InterfaceLine> interfaceLine;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the interfaceLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterfaceLine().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InterfaceLine> getInterfaceLine() {
        if (interfaceLine == null) {
            interfaceLine = new ArrayList<InterfaceLine>();
        }
