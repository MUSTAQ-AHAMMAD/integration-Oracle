 ...
 *         &lt;element name="interfaceSalesCredit" type="{http://xmlns.oracle.com/apps/financials/receivables/transactions/invoices/invoiceService/}InterfaceSalesCredit" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "processInterfaceSalesCreditAsync")
public class ProcessInterfaceSalesCreditAsync {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<InterfaceSalesCredit> interfaceSalesCredit;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the interfaceSalesCredit property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterfaceSalesCredit().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InterfaceSalesCredit> getInterfaceSalesCredit() {
        if (interfaceSalesCredit == null) {
            interfaceSalesCredit = new ArrayList<InterfaceSalesCredit>();
        }
        return this.interfaceSalesCredit;
    }
