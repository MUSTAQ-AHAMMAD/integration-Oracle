...
/**
 * <p>Java class for TransactionHeaderGdfJE_5FDE_5FZ4_5FREPORTING complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TransactionHeaderGdfJE_5FDE_5FZ4_5FREPORTING">
 *   &lt;complexContent>
...
@XmlType(name = "TransactionHeaderGdfJE_5FDE_5FZ4_5FREPORTING", propOrder = {
    "recordType",
    "recordTypeDisplay",
    "reason",
    "reasonDisplay"
})
public class TransactionHeaderGdf2
    extends TransactionHeaderGdf
{

    @XmlElementRef(name = "_Record__Type", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recordType;
    @XmlElementRef(name = "_Record__Type_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> recordTypeDisplay;
    @XmlElementRef(name = "_Reason", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> reason;
    @XmlElementRef(name = "_Reason_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
