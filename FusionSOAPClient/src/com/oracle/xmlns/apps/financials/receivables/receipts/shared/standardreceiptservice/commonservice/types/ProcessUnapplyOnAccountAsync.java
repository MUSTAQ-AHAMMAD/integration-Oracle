 ...
 *         &lt;element name="unapplyOnAccount" type="{http://xmlns.oracle.com/apps/financials/receivables/receipts/shared/standardReceiptService/commonService/}UnapplyOnAccount" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "processUnapplyOnAccountAsync")
public class ProcessUnapplyOnAccountAsync {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<UnapplyOnAccount> unapplyOnAccount;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the unapplyOnAccount property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUnapplyOnAccount().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<UnapplyOnAccount> getUnapplyOnAccount() {
        if (unapplyOnAccount == null) {
            unapplyOnAccount = new ArrayList<UnapplyOnAccount>();
        }
        return this.unapplyOnAccount;
    }
