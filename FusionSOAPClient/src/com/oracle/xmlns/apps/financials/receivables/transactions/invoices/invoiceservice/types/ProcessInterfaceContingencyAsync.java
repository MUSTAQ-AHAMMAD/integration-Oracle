 ...
 *         &lt;element name="interfaceContingency" type="{http://xmlns.oracle.com/apps/financials/receivables/transactions/invoices/invoiceService/}InterfaceContingency" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "processInterfaceContingencyAsync")
public class ProcessInterfaceContingencyAsync {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<InterfaceContingency> interfaceContingency;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the interfaceContingency property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterfaceContingency().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InterfaceContingency> getInterfaceContingency() {
        if (interfaceContingency == null) {
            interfaceContingency = new ArrayList<InterfaceContingency>();
        }
        return this.interfaceContingency;
    }
