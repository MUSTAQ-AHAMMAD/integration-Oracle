...
/**
 * <p>Java class for TransactionLineInterfaceGdfJE_5FIT_5FESL_5FOF_5FSERVICES complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TransactionLineInterfaceGdfJE_5FIT_5FESL_5FOF_5FSERVICES">
 *   &lt;complexContent>
...
@XmlType(name = "TransactionLineInterfaceGdfJE_5FIT_5FESL_5FOF_5FSERVICES", propOrder = {
    "serviceCode",
    "serviceCodeDisplay",
    "serviceMode",
    "serviceModeDisplay",
...
public class TransactionLineInterfaceGdf1
    extends TransactionLineInterfaceGdf
{

    @XmlElementRef(name = "_Service__Code", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> serviceCode;
    @XmlElementRef(name = "_Service__Code_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> serviceCodeDisplay;
    @XmlElementRef(name = "_Service__Mode", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> serviceMode;
    @XmlElementRef(name = "_Service__Mode_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> serviceModeDisplay;
    @XmlElementRef(name = "reportingExclusionIndicator", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> reportingExclusionIndicator;
    @XmlElementRef(name = "reportingExclusionIndicator_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
