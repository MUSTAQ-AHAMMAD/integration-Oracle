...
/**
 * <p>Java class for TransactionHeaderGdfJE_5FES_5FMODELO415_5F347PR complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TransactionHeaderGdfJE_5FES_5FMODELO415_5F347PR">
 *   &lt;complexContent>
...
@XmlType(name = "TransactionHeaderGdfJE_5FES_5FMODELO415_5F347PR", propOrder = {
    "propertyLocation",
...
public class TransactionHeaderGdf8
    extends TransactionHeaderGdf
{

    @XmlElementRef(name = "_Property__Location", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> propertyLocation;
    @XmlElementRef(name = "_Property__Location_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> propertyLocationDisplay;
    @XmlElementRef(name = "_Transmission__of__Property", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transmissionOfProperty;
    @XmlElementRef(name = "_Transmission__of__Property_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionHeaderGdf/", type = JAXBElement.class, required = false)
