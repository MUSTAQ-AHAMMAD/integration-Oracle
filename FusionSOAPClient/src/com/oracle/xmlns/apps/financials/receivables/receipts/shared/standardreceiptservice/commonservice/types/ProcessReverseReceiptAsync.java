 ...
 *         &lt;element name="reverseReceipt" type="{http://xmlns.oracle.com/apps/financials/receivables/receipts/shared/standardReceiptService/commonService/}ReverseReceipt" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "processReverseReceiptAsync")
public class ProcessReverseReceiptAsync {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<ReverseReceipt> reverseReceipt;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the reverseReceipt property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReverseReceipt().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<ReverseReceipt> getReverseReceipt() {
        if (reverseReceipt == null) {
            reverseReceipt = new ArrayList<ReverseReceipt>();
        }
