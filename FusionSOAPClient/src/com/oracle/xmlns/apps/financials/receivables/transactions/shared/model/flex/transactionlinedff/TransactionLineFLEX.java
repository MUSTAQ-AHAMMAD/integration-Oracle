...
/**
 * <p>Java class for TransactionLineFLEX complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TransactionLineFLEX">
 *   &lt;complexContent>
...
@XmlType(name = "TransactionLineFLEX", propOrder = {
    "customerTrxLineId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class TransactionLineFLEX {

    @XmlElement(name = "CustomerTrxLineId")
    protected Long customerTrxLineId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionLineDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionLineDff/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionLineDff/", type = JAXBElement.class, required = false)
