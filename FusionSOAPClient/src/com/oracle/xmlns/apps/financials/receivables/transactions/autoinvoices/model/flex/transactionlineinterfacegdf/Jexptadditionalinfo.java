    ...
    extends TransactionLineInterfaceGdf
{
    ...
    @XmlElementRef(name = "ARCno", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> arCno;
    @XmlElementRef(name = "ExcisePayment", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
