 ...
 *         &lt;element name="interfaceDistribution" type="{http://xmlns.oracle.com/apps/financials/receivables/transactions/invoices/invoiceService/}InterfaceDistribution" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlRootElement(name = "processInterfaceDistributionAsync")
public class ProcessInterfaceDistributionAsync {

    @XmlElement(required = true)
    protected String changeOperation;
    protected List<InterfaceDistribution> interfaceDistribution;
    @XmlElement(required = true)
     ...
     * This is why there is not a <CODE>set</CODE> method for the interfaceDistribution property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInterfaceDistribution().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<InterfaceDistribution> getInterfaceDistribution() {
        if (interfaceDistribution == null) {
            interfaceDistribution = new ArrayList<InterfaceDistribution>();
        }
