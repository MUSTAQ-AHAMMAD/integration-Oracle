...
/**
 * <p>Java class for TransactionLineGdf complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TransactionLineGdf">
 *   &lt;complexContent>
...
@XmlType(name = "TransactionLineGdf", propOrder = {
    "customerTrxLineId",
...
@XmlSeeAlso({
    TransactionLineGdf1.class,
    JExRUAdditionalInfo.class,
    JExPLAdditionalInfo.class,
    Jexptadditionalinfo.class,
    AdditionalInfoForIndia.class,
    JLxBRAdditionalInfo.class,
    JExTRBaBsReporting.class,
    JExHUAdditionalInfo.class,
    JExROAdditionalInfo.class
})
public class TransactionLineGdf {

    @XmlElement(name = "CustomerTrxLineId")
    protected Long customerTrxLineId;
    @XmlElementRef(name = "FLEX_PARAM_GLOBAL_COUNTRY_CODE", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionLineGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexparamglobalcountrycode;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionLineGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionLineGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/shared/model/flex/TransactionLineGdf/", type = JAXBElement.class, required = false)
