...
/**
 * <p>Java class for TransactionInterfaceGdfJE_5FES_5FMODELO347PR complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TransactionInterfaceGdfJE_5FES_5FMODELO347PR">
 *   &lt;complexContent>
...
@XmlType(name = "TransactionInterfaceGdfJE_5FES_5FMODELO347PR", propOrder = {
    "propertyLocation",
...
public class TransactionInterfaceGdf4
    extends TransactionInterfaceGdf
{

    @XmlElementRef(name = "_Property__Location", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> propertyLocation;
    @XmlElementRef(name = "_Property__Location_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> propertyLocationDisplay;
    @XmlElementRef(name = "_Transmission__of__Property", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> transmissionOfProperty;
    @XmlElementRef(name = "_Transmission__of__Property_Display", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "_Year__of__Amount__Received__in__Cas", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionInterfaceGdf/", type = JAXBElement.class, required = false)
    ...
    public void setTransmissionOfProperty(JAXBElement<String> value) {
        this.transmissionOfProperty = value;
    }
    ...
    public void setTransmissionOfPropertyDisplay(JAXBElement<String> value) {
        this.transmissionOfPropertyDisplay = value;
    }
