...
/**
 * <p>Java class for JExHUAdditionalInfo complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="JExHUAdditionalInfo">
 *   &lt;complexContent>
...
@XmlType(name = "JExHUAdditionalInfo", propOrder = {
    "taxPointDate",
    "tpdHistory"
})
public class JExHUAdditionalInfo
    extends TransactionLineInterfaceGdf
{

    @XmlElementRef(name = "TaxPointDate", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> taxPointDate;
    @XmlElementRef(name = "TPDHistory", namespace = "http://xmlns.oracle.com/apps/financials/receivables/transactions/autoInvoices/model/flex/TransactionLineInterfaceGdf/", type = JAXBElement.class, required = false)
